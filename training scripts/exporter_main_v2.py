...
more specific example: python .\exporter_main_v2.py --input_type image_tensor --pipeline_config_path .\models\my_model2\pipeline.config --trained_checkpoint_dir .\models\my_model2 --output_directory .\exported-models\my_model2
